      ...
      className={cn(
        tabsListVariants({ variant }),
         "w-fit justify-center",
          "max-md:w-full max-md:justify-start max-md:overflow-x-auto max-md:flex-nowrap",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        isError && "text-destructive hover:text-destructive dark:text-destructive dark:hover:text-destructive data-active:text-destructive dark:data-active:text-destructive group-data-[variant=line]/tabs-list:data-active:text-destructive after:bg-destructive dark:after:bg-destructive",
        className
      )}
      {...props}
    />
